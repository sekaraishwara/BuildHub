                            ...
                            <div class="row">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-start align-items-center">
                                                ...
                                                <div>
                                                    <span class="d-block font-weight-bold text-uppercase">Transaction</span>
                                                    <h2 class="mb-0">0</h2>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="card-footer">
                                            <div class="text-right">
                                                <a href="{{ route('store.transaction') }}"
                                                    class="text-secondary text-muted">All Order </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="d-flex justify-content-start align-items-center">
                                                ...
                                                <div>
                                                    <span class="d-block font-weight-bold text-uppercase">My Product</span>
                                        ...
                                        <div class="card-footer">
                                            <div class="text-right">
                                                <a href="{{ route('store.product') }}" class="text-secondary text-muted">All
                                                    Products </a>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-lg-6 col-md-6 pt-5">
                                    <div class="card">
                                        ...
                                        <div class="card-footer">
                                            <div class="text-right">
                                                <a href="#" class="text-secondary text-muted">See Details
                                                </a>
                                            </div>
                                        </div>
                                    </div>
