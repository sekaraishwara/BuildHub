                    ...
                    <div class="col-12">
                        <div class="bread-inner">
                            <ul class="bread-list">
                                ...
                                <li class="active"><a href="{{ route('professional.service') }}">Invoice</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    @foreach ($allOrder as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a
                                                    href="{{ route('professional.service.order.show', $item->invoice_no) }}"><i
                                                        class="ti-eye mx-2 text-primary"></i>
                                                </a>
                                                <form action="{{ route('professional.service.order.delete', $item->id) }}"
