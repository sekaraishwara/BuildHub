                ...
                <div class="col-12">
                    <div class="bread-inner">
                        <ul class="bread-list">
                            ...
                            <li><a href="{{ route('store') }}">Professional<i class="ti-arrow-right"></i></a></li>
                            <li class="active"><a
                                    href="blog-single.html">{{ $serviceProfessional?->professional->name }}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="shop product single-item">
                <div class="d-flex justify-content-between">
                    <div class="col-md-4 product-image">
                        <img id="uploadedImage" src="{{ $serviceProfessional?->image }}" alt="">
                    </div>
                    <div class="col-md-8 product-text">
                        <h4>{{ $serviceProfessional?->name }}
                        </h4>
                        ...
                        <div class="row">
                            <form action="{{ route('customer.cart.addToCart') }}" method="POST">
                                @csrf
                                <div class="d-none">
                                    <input name="product_id" value="{{ $serviceProfessional?->id }}">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="col-md-9">
                            <div class="store-info ml-2">
                                <span class="store-name">{{ $serviceProfessional?->professional->name }}</span> <br>
                                <span class="text-muted">Bergabung sejak
                                    {{ $serviceProfessional?->professional->created_at->format('M Y') }}</span>
                            </div>
                        </div>
                    </div>
