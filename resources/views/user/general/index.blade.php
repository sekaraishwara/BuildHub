...
@section('contents')
    ...
    <div class="product-area most-popular section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2>Interior Designer Indonesia</h2>
                    </div>
                </div>
                <p>Lihat rekomendasi <span class="font-weight-bold mx-2">semua</span> budget</p>
            </div>
    ...
    {{-- Tagline Help Center --}}
    <section class="shop-services section tagline my-5">
        <div class="container">
            <div class="row">
            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-6 col-12 padding-right">
                        <div class="image">
                            <img src="{{ asset('layout/asset/images/material_1.png') }}" alt="#">
                        </div>
                    </div>
                    <div class="col-lg-6 col-12 padding-left">
                        <div class="content">
                            <div class="heading-block">
                                ...
                                <h1 class="my-3">Ragam Pilihan Produk <br> untuk Bangunan Anda</h1>
    ...
    <div class="product-area most-popular section">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section-title">
                        <h2>Rekomendasi Toko Keramik</h2>
                    </div>
                </div>
                <p>Lihat rekomendasi <span class="font-weight-bold mx-2"> semua</span> budget</p>
            </div>
